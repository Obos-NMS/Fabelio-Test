...
<div class="nav-wrapper" >
  <nav class="navbar navbar-expand-lg text-center container-fluid-nav text-center" id="nav-body">
      <a class="navbar-brand" href="#"><b>Test-Fabelio</b></a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          <li v-if="currentRoute.path === '/products' && role == 'admin'" class="nav-item">
            ...
            id="nav-login" href="#"><b>Release New Product! </b></router-link>
          </li>
          ...
          <li class="nav-item">
            ...
            id="nav-login" href="#">Our Products</router-link>
          </li>
  ...
  methods: {
    logout () {
      ...
      if (this.currentRoute.path !== '/') {
        ...
        Toast.fire({
          icon: 'success',
          title: 'You have logged out, Thank you for using Fabelio-Test'
        })
      }
    }
  },
